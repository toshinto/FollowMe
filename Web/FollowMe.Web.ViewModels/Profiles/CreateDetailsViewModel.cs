...
namespace FollowMe.Web.ViewModels.Profiles
{
    public class CreateDetailsViewModel
    {
        ...
        [MinLength(3)]
        [MaxLength(10)]
        [RegularExpression("[A-Z][a-z]{2,9}", ErrorMessage = "Your first name must start with upper letter and followed by lower letters and no longer than 15 characters")]
