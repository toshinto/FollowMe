#pragma checksum "D:\FollowMe\FollowMe\Web\FollowMe.Web\Views\Profiles\Profile.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "79aef4694eca22a3d3d3a106c973fa79251330a9"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"79aef4694eca22a3d3d3a106c973fa79251330a9", @"/Views/Profiles/Profile.cshtml")]
            ...
            <div class=""panel panel-default"">
                <div class=""panel-body"">
                    ...
                    <div class=""row pv-lg"">
                        ...
                        <div class=""col-lg-8"">
                            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "79aef4694eca22a3d3d3a106c973fa79251330a94992", async() => {
                WriteLiteral(@"
                                <div class=""form-group"">
                                    <label class=""control-label"" for=""inputContact1"">Birthday: </label>
                                    <hr />
                                    <label class=""control-label"" for=""inputContact1"">Height: </label>
                                    <hr />
                                    <label class=""control-label"" for=""inputContact1"">Weight: </label>
                                    <hr />
                                    <label class=""control-label"" for=""inputContact1"">Gender: </label>
                                    <hr />
                                    <label class=""control-label"" for=""inputContact1"">Eyes color: </label>
                                    <hr />
                                    <label class=""control-label"" for=""inputContact1"">Hair color: </label>
                                    <hr />
                                    <label class=""control-label"" for=""in");
                WriteLiteral(@"putContact1"">Status: </label>
                                    <hr />
                                    <label class=""control-label"" for=""inputContact1"">What are you searching for: </label>
                               </div>
