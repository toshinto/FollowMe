...
namespace FollowMe.Services.Data
{
    public class PostsService : IPostsService
    {
        ...
        {
            var userPhotoStorage =
                this.usersRepository
                .All()
                .Where(x => x.Id == sentBy)
                .Select(x => x.UserCharacteristics.Photo.Id + "." + x.UserCharacteristics.Photo.Extension)
                .FirstOrDefault();
        ...
        public string GetNameById(string userId)
        {
            var user =
                ...
                .All()
                .Where(x => x.Id == userId)
                .Select(x => x.UserCharacteristics.FullName)
                .FirstOrDefault();
        ...
        public string GetCreatorOfPostByCommentId(string id)
        {
            var userFullName =
                ...
                .All()
                .Where(x => x.Id == id)
                .Select(x => x.SentBy.UserCharacteristics.FullName)
                .FirstOrDefault();
